function wts = fft2jbarkmx(nfft, sr, nfilts, width, minfreq, maxfreq)
...
min_bark = hz2jbark(minfreq);
nyqbark = hz2jbark(maxfreq) - min_bark;
if nfilts == 0
...
binbarks = hz2jbark([0:nfft/2]*sr/nfft);
